...
const SingleBlog = () => {
  ...
  const [blog, setBlog] = useState(location.state?.updatedBlog || {});
            ...
            <div className="bg-white relative top-0 -mt-32 p-5 sm:p-10">
              ...
              <div className="flex justify-between">
                <p className="text-gray-700 text-xs mt-2">
                  ...
                  <a
                    href="#"
                    className="text-indigo-600 font-medium hover:text-gray-900 transition duration-500 ease-in-out mr-2"
                  >
                    {blog.category}
                  </a>
                  <a
